...
typedef enum{
  ...
  FADING_MODE_DERIVATIVE_BASED_ON_PWMS,/* Derivative Mode, the PWMs would change in nonlinear mode; the PWMs changes is softer*/
}FadingMode_t;
...
typedef enum{
  ...
  COLOR_MODE_CustomizedRGBL,
  COLOR_MODE_CustomizedRGB_ABS_L,
}ColorMode_t;
...
/*
 *  Set xy physical intensity output  for example: P(x,y) = (0.33333,0.33333) x = 0.33333*65536 = 21845, y = 0.33333*65536 = 21845  intensity: lumen or mcd
 *  @param [in] temperature: -40-100 in 1C
 *  @param [in] x: 0-65535
 *  @param [in] y: 0-65535
...
/*
 *  Set uv phy intensity output,intensity: lumen or mcd
 *  @param [in] temperature: -40-100 in 1C
 *  @param [in] u: 0-1023
 *  @param [in] v: 0-1023
 *  @param [in] intensity: 0-65535, lumen or mcd, if intensity value is higher than maximum intensity of the target color, it would display maximum intensity of the target color.
...
/*
 *  Set sRGBL output sRGB red={0.64,0.33}; green = {0.3,0.6};blue = {0.15,0.06} w = {0.3127,0.3290} with gamma=2.2
 *  @param [in] temperatureR,G,B: -40-100 in 1C
 *  @param [in] red: 0-255
 *  @param [in] green: 0-255
 *  @param [in] blue: 0-255
...
/*
 *  Set sRGB absolute phy intensity output lumen or mcd, sRGB red={0.64,0.33}; green = {0.3,0.6};blue = {0.15,0.06} w = {0.3127,0.3290} with gamma=2.2
 *  @param [in] temperature: -40-100 in 1C
 *  @param [in] red: 0-255
 *  @param [in] green: 0-255
 *  @param [in] blue: 0-255
 ...
 *  @return 0
 */
uint8_t CLM_SetCustomizedRGBCoordinates(CPoint_t cR,CPoint_t cG,CPoint_t cB,CPoint_t cW);

/*
 *  Get customized sRGB parameters configuration
 *  @param [out] cR,cG,cB,cW is the referred red/greed/blue/white coordinate
 *  @return 0
 */
uint8_t CLM_GetCustomizedRGBCoordinates(CPoint_t *const cR,CPoint_t *const cG,CPoint_t *const cB,CPoint_t *const cW);

/*
 *  Set customizedRGBL output 
 *  @param [in] temperature: -40-100 in 1C
 *  @param [in] red: 0-65535
 *  @param [in] green: 0-65535
 *  @param [in] blue: 0-65535
 *  @param [in] level: 0-1023
 *  @param [in] transitionTime: 0-65535ms
 *  @return 0
 */
uint8_t CLM_SetCustomizedRGBL(LedNum_t ledIndex,ColorTemperature_t temperature,uint16_t red, uint16_t green, uint16_t blue,uint16_t level, uint16_t transitionTime);

/*
 *  Set customizedRGBAbsL output 
 *  @param [in] temperature: -40-100 in 1C
 *  @param [in] red: 0-65535
 *  @param [in] green: 0-65535
 *  @param [in] blue: 0-65535
 ...
 *  @return 0
 */
uint8_t CLM_SetCustomizedRGBAbsL(LedNum_t ledIndex,ColorTemperature_t temperature,uint16_t red, uint16_t green, uint16_t blue,uint16_t intensity, uint16_t transitionTime);
