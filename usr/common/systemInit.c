...
void LINS_GPIOInit(void)
{
  SYSCTRLA_REG_DEBUG_ACCESS_KEY.DEBUG_ACCESS_KEY = 0x05u;

  IOCTRLA_SFRS->LIN.LINS_HWMODE = 0U;
  IOCTRLA_SFRS->LIN.LINS_PU30K_ENA = 1U;
  IOCTRLA_SFRS->LIN.LINS_TXENA = 1U;
  IOCTRLA_SFRS->LIN.LINS_RXENA = 1U;
  IOCTRLA_SFRS->LIN.SWON = 0U;
  IOCTRLA_SFRS->LIN.DS_SWON = 0U;
}

void LINM_GPIOInit(void)
{
  SYSCTRLA_REG_DEBUG_ACCESS_KEY.DEBUG_ACCESS_KEY = 0x05u;

  IOCTRLA_SFRS->LIN.LINM_HWMODE = 0U;
  IOCTRLA_SFRS->LIN.LINM_RXENA = 1U;
  IOCTRLA_SFRS->LIN.LINM_TXENA = 1U;
  IOCTRLA_SFRS->LIN.LINM_PU1K_ENA = 1U;
  IOCTRLA_SFRS->LIN.SWON = 0U;
  IOCTRLA_SFRS->LIN.DS_SWON = 0U;
}
