...
typedef struct{
    ...
    intfunc_t _WICA_Handler;           /* ASIC irq 0 - Wake Up LIN */
    intfunc_t _PWMAUX_Handler;          /* ASIC irq 1 - PWM Aux -GPIO PWMs*/
    intfunc_t _IOCTRLA_Handler;         /* ASIC irq 2 - Wake Up TIMER */
...
static const intvecTable_t __vector_table =
{
  ...
  ._WICA_Handler                = WICA_Handler,        /* ASIC irq 0 - Wake Up LIN - WICA*/
  ._PWMAUX_Handler              = PWMAUX_Handler,       /* ASIC irq 1 - PWM Aux -GPIO PWMs*/
  ._IOCTRLA_Handler             = IOCTRLA_Handler,      /* ASIC irq 2 - IOCTRLA_Handler*/
