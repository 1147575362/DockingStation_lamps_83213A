...
LedTarget_t CFL_LuvToDutyCycle (LedNum_t ledIndex,IntensityRatio_t iRatio,ColorTemperature_t temperature,uint8_t isPhysicaY, uint16_t u, uint16_t v,uint16_t level);
...
LedTarget_t CFL_CustomizedRGBLToDutyCycle(LedNum_t ledIndex,IntensityRatio_t iRatio,ColorTemperature_t temperature,uint8_t isPhysicalY,uint16_t Red, uint16_t Green, uint16_t Blue,uint16_t level);
...
uint8_t CFL_SetCustomizedRGBCoordinates(CPoint_t r,CPoint_t g,CPoint_t b,CPoint_t cW);
uint8_t CFL_GetCustomizedRGBCoordinates(CPoint_t *const cR,CPoint_t *const cG,CPoint_t *const cB,CPoint_t *const cW);

CPoint_t CFL_sRGBToxy(uint8_t Red, uint8_t Green, uint8_t Blue);
...
uint32_t CFL_GetLastMaxIntensityOfTargetColor(void);
